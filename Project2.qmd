...
paste0("Standard Deviation: ", round(sd(superstore$Sales), 3))
```
...
paste0("Standard Deviation: ", round(sd(superstore$Quantity), 3))
```
...
paste0("Standard Deviation: ", round(sd(superstore$Discount), 3))
```
...
paste0("Standard Deviation: ", round(sd(superstore$Profit), 3))
```
